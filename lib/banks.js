...
function detectBankFromCode(code, country) {
  ...
  if (country === 'United States') {
    ...
    if (digits.length >= 4) {
      ...
      // Specific 8-digit patterns to resolve shared Federal Reserve routing centers
      if (prefix8 === '02120002') return "Bank of America";
      if (prefix8 === '02120001') return "JPMorgan Chase & Co.";

      if (['0210', '0211', '0213', '0710', '1110'].includes(prefix4)) return "JPMorgan Chase & Co.";
  ...
  if (country === 'Germany' || country === 'France') {
    if (clean.startsWith('DE')) {
      ...
      if (bankCode === '39996' || bankCode.startsWith('18') || bankCode.startsWith('15')) return "Crédit Agricole Group";
      if (bankCode === '10278' || bankCode === '30007') return "Crédit Mutuel Alliance Fédérale";
      if (bankCode === '20041') return "La Banque Postale";
      if (bankCode.startsWith('175') || bankCode.startsWith('131') || bankCode.startsWith('122') || bankCode.startsWith('182')) return "Groupe BPCE (Banque Populaire & Caisse d'Epargne)";
    }
  }
